...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6906329858705663546L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"com.javatechie.dto\",\"fields\":[{\"name\":\"studentName\",\"type\":\"string\"},{\"name\":\"studentId\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"}]}");
   ...
   */
  public static com.javatechie.dto.Student.Builder newBuilder() {
    return new com.javatechie.dto.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.javatechie.dto.Student.Builder newBuilder(com.javatechie.dto.Student.Builder other) {
    return new com.javatechie.dto.Student.Builder(other);
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static com.javatechie.dto.Student.Builder newBuilder(com.javatechie.dto.Student other) {
    return new com.javatechie.dto.Student.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.javatechie.dto.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.javatechie.dto.Student other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.studentName)) {
        this.studentName = data().deepCopy(fields()[0].schema(), other.studentName);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javatechie.dto.Student.Builder setStudentName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javatechie.dto.Student.Builder clearStudentName() {
      studentName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javatechie.dto.Student.Builder setStudentId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javatechie.dto.Student.Builder clearStudentId() {
      studentId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javatechie.dto.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.javatechie.dto.Student.Builder clearAge() {
